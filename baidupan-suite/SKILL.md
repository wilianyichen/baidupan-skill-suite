...
```bash
# 网盘浏览
~/tools/baidupan-tools/.venv/bin/python ~/tools/baidupan-tools/bypy-enhanced/scripts/bdpan_enhanced.py whoami
~/tools/baidupan-tools/.venv/bin/python ~/tools/baidupan-tools/bypy-enhanced/scripts/bdpan_enhanced.py list /
~/tools/baidupan-tools/.venv/bin/python ~/tools/baidupan-tools/bypy-enhanced/scripts/bdpan_enhanced.py tree /开智 -d 2 --size none
~/tools/baidupan-tools/.venv/bin/python ~/tools/baidupan-tools/bypy-enhanced/scripts/bdpan_enhanced.py du /开智
~/tools/baidupan-tools/.venv/bin/python ~/tools/baidupan-tools/bypy-enhanced/scripts/bdpan_enhanced.py search Python / --limit 20
~/tools/baidupan-tools/.venv/bin/python ~/tools/baidupan-tools/bypy-enhanced/scripts/bdpan_enhanced.py metas /Python\ 编程指南.pdf
